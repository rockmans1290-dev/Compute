...
Open this folder in Android Studio, let Gradle sync, then run the `app` configuration on an Android device or emulator.

## Notes

- Language: Kotlin
- UI: Native Android Canvas custom view
